<!-- app/views/templates/login.blade.php -->
@extends('templates.login_template') {{-- Populate head section on main
template with needed scripts. --}} @section('box')
...
<div id="loginbox" style="margin-top: 50px;"
	...
	<div class="panel panel-info">
		...
		<div style="padding-top: 30px" class="panel-body">
			...
			<form id="loginform" class="form-horizontal" role="form" action='{{URL::route("login_post")}}' method="POST">
				...
				<div style="margin-top: 10px" class="form-group">
					...
					<div class="col-sm-12 controls">
						...
						<a style="display: none" id="btn-fblogin" href="#"
				...
				<div class="form-group">
					<div class="col-md-12 control">
						<div
							...
							Don't have an account! <a href='{{URL::route("register")}}'> Sign
								Up Here </a>
						</div>
					</div>
				</div>
